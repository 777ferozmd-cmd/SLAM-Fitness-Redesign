...
export default function CTABanner() {
  return (
    <section className="bg-ferous-accent py-20 overflow-hidden relative">
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-20 relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <motion.div 
          ...
          className="shrink-0"
        >
          <Link href="/contact" className="inline-flex items-center justify-center bg-ferous-bg text-white font-bold py-4 px-8 rounded-none hover:bg-white hover:text-ferous-bg transition-colors duration-300 text-lg uppercase tracking-wider group">
            Claim Free Trial
