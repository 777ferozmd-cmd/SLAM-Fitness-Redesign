        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="flex flex-col gap-12">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${CONTACT.customerCare.replace(/\s+/g, '')}`} className="text-white hover:text-ferous-accent transition-colors font-medium text-lg block">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-ferous-muted leading-relaxed max-w-[280px]">
            ...
            <div className="w-full h-[300px] bg-[#141414] border border-[#2A2A2A] rounded-2xl overflow-hidden relative grayscale hover:grayscale-0 transition-all duration-500">
              <iframe 
                src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=18/70,%20Halls%20Road,%20Kilpauk,%20Chennai+(Ferous%20Fitness%20Studio)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                allowFullScreen={false} 
                loading="lazy"
                title="Ferous Fitness Corporate Office"
              ></iframe>
            </div>
