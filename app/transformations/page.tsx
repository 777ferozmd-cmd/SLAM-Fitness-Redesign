...
export const metadata: Metadata = {
  title: "Transformations Gallery — Ferous Fitness Studio",
  description: "Real people. Real results. View the incredible transformations our members have achieved at Ferous Fitness Studio.",
};
  ...
  return (
    <main className="flex-grow pt-[80px]">
      ...
      <ServiceHero 
        ...
        title={<>Real People. <span className="text-ferous-accent">Real Results.</span></>}
        imageSrc="https://images.unsplash.com/photo-1540497077202-7c8a3999166f?q=80&w=2070&auto=format&fit=crop"
        imageAlt="Ferous Fitness Results"
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { 
                name: "Anjali M.", 
                program: "Weight Loss", 
                quote: "I had tried everything before joining Ferous. The coaches here actually built a program that fit my crazy work schedule. I've never felt healthier or more confident." 
              },
              { 
                name: "Sanjay K.", 
              ...
              <SpotlightCard 
                key={idx} 
                className="bg-ferous-card p-8 rounded-2xl border-l-[3px] border-l-ferous-accent border-y border-r border-ferous-border relative"
              >
                ...
                <div>
                  ...
                  <div className="text-ferous-accent text-[13px] font-bold uppercase tracking-wider mt-1">
                    {testimonial.program}
                  </div>
                </div>
              </SpotlightCard>
