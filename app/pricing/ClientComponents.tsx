...
const FAQS = [
  ...
  { q: "What's included in each plan?", a: "All plans include full gym access, cardio and weights areas, and locker facilities. Our SLAMer plan adds nutrition guidance and body composition scans. The Elite plan includes dedicated personal training, custom diet plans, and priority booking." },
  ...
  { q: "Is there a free trial?", a: "Yes, we offer a complimentary free trial session for all new visitors. This gives you a chance to experience the SLAM atmosphere, equipment, and community before making a commitment." }
];
