...
export const metadata: Metadata = {
  ...
  description: "Improve real-world strength, mobility, and endurance with SLAM's functional training programs. Move better and perform harder.",
};
  ...
  return (
    <main className="flex-grow pt-[80px]">
      ...
      <ServiceHero 
        ...
        title={<><span className="text-slam-accent">Move Better.</span> Perform Harder.</>}
        imageSrc="https://images.unsplash.com/photo-1599058917212-d750089bc07e?q=80&w=2069&auto=format&fit=crop"
        imageAlt="Functional Training at SLAM"
      />
