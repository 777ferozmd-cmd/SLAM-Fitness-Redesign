        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-20">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            ...
            <Link 
              ...
              className="group flex items-center gap-2 text-white font-bold tracking-wider uppercase text-[14px] hover:text-ferous-accent transition-colors"
            >
              See All Gallery
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={idx} className="group relative overflow-hidden bg-ferous-card border-none p-0">
                ...
                <div className="p-6 relative z-10">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-ferous-muted text-[14px]">{card.time}</span>
                  </div>
                  <p className="text-ferous-accent text-[14px] font-medium uppercase tracking-wider">
                    {card.tag}
                  </p>
                </div>
              </Card>
